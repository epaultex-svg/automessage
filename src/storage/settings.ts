...
import {
  ...
  LEGACY_GPT_4O_MINI_MODEL,
  LEGACY_NVIDIA_NEMOTRON_3_SUPER_MODEL,
  LEGACY_QWEN_FREE_MODEL,
  LEGACY_QWEN_PAID_MODEL,
  NEMOTRON_3_SUPER_MODEL,
  UNPREFIXED_GEMMA_4_31B_MODEL,
  UNPREFIXED_GPT_OSS_120B_MODEL,
  UNPREFIXED_NEMOTRON_3_SUPER_MODEL,
} from "../types";
...
const MODEL_ALIASES: ReadonlyMap<string, string> = new Map([
  [UNPREFIXED_GPT_OSS_120B_MODEL, GPT_OSS_120B_MODEL],
  [UNPREFIXED_GEMMA_4_31B_MODEL, GEMMA_4_31B_MODEL],
  [UNPREFIXED_NEMOTRON_3_SUPER_MODEL, NEMOTRON_3_SUPER_MODEL],
  [LEGACY_NVIDIA_NEMOTRON_3_SUPER_MODEL, NEMOTRON_3_SUPER_MODEL],
  [LEGACY_CLAUDE_HAIKU_MODEL, DEFAULT_SETTINGS.model],
  [LEGACY_QWEN_PAID_MODEL, DEFAULT_SETTINGS.model],
  [LEGACY_QWEN_FREE_MODEL, DEFAULT_SETTINGS.model],
  [LEGACY_GPT_4O_MINI_MODEL, DEFAULT_SETTINGS.model],
]);
